...
summary_table_2  <- rbind(summary_table[1:14, ], summary_table[5114:5117, ])




write.table(summary_table_2, file = "/data/sikeme/TRADE/WTO/result/regression_HS2/regression_results_H2_UNCTAD_IV.csv", sep = ",", row.names = FALSE)
...
combined_df_AVE_UNCTAD_SPS <- rownames_to_column(combined_df_AVE_UNCTAD_SPS, var = "HS_level")
write.csv(combined_df_AVE_UNCTAD_SPS, file = "/data/sikeme/TRADE/WTO/result/regression_HS2/AVE_SPS_H2_UNCTAD_IV.csv",  row.names = TRUE)
...
combined_df_AVE_UNCTAD_TBT <- rownames_to_column(combined_df_AVE_UNCTAD_TBT, var = "HS_level")
write.csv(combined_df_AVE_UNCTAD_TBT, file = "/data/sikeme/TRADE/WTO/result/regression_HS2/AVE_TBT_H2_UNCTAD_IV.csv",  row.names = TRUE)
