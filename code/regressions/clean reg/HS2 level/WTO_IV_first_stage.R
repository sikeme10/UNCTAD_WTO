...
for (country in countries) {
  # Construct file paths for SPS and TBT data
  sps_file_path <- paste0("dta_WTO/NTM_data/countries/clean_WTO_SPS_", country, ".csv")
  tbt_file_path <- paste0("dta_WTO/NTM_data/countries/clean_WTO_TBT_", country, ".csv")
...
write.csv(SPS, "BRA/IVs/cleaning_SPS2.csv")
...
write.csv(TBT, "BRA/IVs/cleaning_TBT2.csv")
...
TBT <- read_csv("BRA/IVs/cleaning_TBT2.csv")
SPS <- read_csv("BRA/IVs/cleaning_SPS2.csv")
names(SPS)
