...
summary_table_2  <- rbind(summary_table[1:14, ], summary_table[5036:5039, ])




write.table(summary_table_2, file = "/data/sikeme/TRADE/WTO/result/regression_HS2/regression_results_H2_UNCTAD.csv", sep = ",", row.names = FALSE)
...
write.csv(combined_df_AVE_UNCTAD_SPS, file = "/data/sikeme/TRADE/WTO/result/regression_HS2/AVE_SPS_H2_UNCTAD.csv",  row.names = TRUE)
...
write.csv(combined_df_AVE_UNCTAD_TBT, file = "/data/sikeme/TRADE/WTO/result/regression_HS2/AVE_TBT_H2_UNCTAD.csv",  row.names = TRUE)
