...
################################################################################
# Need to convert some isocodes that are not correct (old versions....)
...
table(trade_share1$ReporterISO3)
names(table(trade_share1$ReporterISO3))



# for reporter
trade_share1 <- trade_share1 %>%
